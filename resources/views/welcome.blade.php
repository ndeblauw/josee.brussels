...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script src="https://cdn.usefathom.com/script.js" data-site="UADHUYUS" defer></script>
    ...
    <body class="min-h-screen flex items-center justify-center bg-cream-100">

        <div class="max-w-full max-h-full md:max-w-1/2 md:max-h-1/2">
